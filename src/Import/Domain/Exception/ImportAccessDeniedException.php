...
/**
 * Exception ImportAccessDeniedException.
 *
 ...
 * gets {@see ImportJobNotFoundException} instead — the 403/404 difference is
 * itself an existence oracle across organizations.
 *
 * Module-owned on purpose, mirroring
 * {@see \Maintenance\Domain\Exception\MaintenanceAccessDeniedException}: the
 * import handlers used to throw the Organization module's
 ...
 */
final class ImportAccessDeniedException extends RuntimeException
{
  // #region Methods
  /**
