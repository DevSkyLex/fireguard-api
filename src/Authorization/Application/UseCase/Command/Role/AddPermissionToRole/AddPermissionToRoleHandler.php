...
/**
 * Handler AddPermissionToRoleHandler.
 *
 * @category Handler
 *
 * @version 1.0.0
 ...
 */
final readonly class AddPermissionToRoleHandler implements CommandHandler
{
  // #region Constructor
  /**
   * Constructor.
   ...
   * Method __invoke.
   *
   * Handles the AddPermissionToRoleCommand.
   *
   * @since 1.0.0
   *
   * @param AddPermissionToRoleCommand $command the command
   *
   * @return AddPermissionToRoleResult the result
   */
  public function __invoke(AddPermissionToRoleCommand $command): AddPermissionToRoleResult
  {
