...
namespace Client\Infrastructure\Symfony\Command;
 ...
 * @final
 *
 * Symfony Console command to create a new OAuth2 client.
 *
 * @category Console Command
 * @package Client\Infrastructure\Symfony\Command
 * @version 1.0.0
 *
...
HELP
  ...
  protected function execute(InputInterface $input, OutputInterface $output): int
  {
    ...
    $grantTypeStrings = $input->getOption('grant-type');
    ...
    try {
      ...
      $plainSecret = $customSecret ?? ClientSecret::generateRandomPlain(32);
