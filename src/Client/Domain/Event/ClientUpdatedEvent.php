 ...
 * @final
 *
 * Raised when a client's details are updated.
 *
 * @category Event
 ...
 */
final readonly class ClientUpdatedEvent implements DomainEvent
{
    //#region Properties
    /**
     * Property eventId
     ...
     * Constructor
     *
     * Initializes a new instance of the ClientUpdatedEvent class.
     *
     * @access public
     * @since 1.0.0
     *
     * @param ClientId $clientId The client ID.
     * @param ClientName $name The updated client name.
