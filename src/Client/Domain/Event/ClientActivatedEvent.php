...
/**
 * Event ClientActivatedEvent
 * @final
 *
 * Raised when an OAuth client is activated.
 *
 * @category Event
 ...
 */
final readonly class ClientActivatedEvent implements DomainEvent
{
  //#region Properties
  /**
   * Property eventId
   ...
   * the ClientActivatedEvent class.
   *
   * @access public
   * @since 1.0.0
   *
