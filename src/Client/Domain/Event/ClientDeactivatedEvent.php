...
/**
 * Event ClientDeactivatedEvent
 * @final
 *
 * Raised when an OAuth client is deactivated.
 *
 * @category Event
 ...
 */
final readonly class ClientDeactivatedEvent implements DomainEvent
{
  //#region Properties
  /**
   * Property eventId
   ...
   * Constructor
   *
   * Initializes a new instance of the ClientDeactivatedEvent class.
   *
   * @access public
   * @since 1.0.0
   *
  ...
  {
    return ['client_id' => $this->clientId->value];
  }
  //#endregion
}
