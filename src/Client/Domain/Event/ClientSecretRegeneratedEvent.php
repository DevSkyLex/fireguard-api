...
/**
 * Event ClientSecretRegeneratedEvent
 * @final
 *
 * Raised when an OAuth client secret is regenerated.
 *
 * @category Event
 ...
 */
final readonly class ClientSecretRegeneratedEvent implements DomainEvent
{
  //#region Properties
  /**
   * Property eventId
   ...
   * ClientSecretRegeneratedEvent class.
   *
   * @access public
   * @since 1.0.0
   *
