 ...
 *
 * Authorizes the caller and clears a scheduled cancellation on the organization's
 * subscription, then returns the refreshed subscription state. Requires the
 ...
 */
final readonly class ResumeSubscriptionProcessor implements ProcessorInterface
{
   ...
   * Constructor.
   *
   * Initializes a new instance of the ResumeSubscriptionProcessor class.
   *
   * @since 1.0.0
   *
