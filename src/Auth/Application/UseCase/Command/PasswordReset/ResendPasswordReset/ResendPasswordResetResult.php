...
/**
 * Class ResendPasswordResetResult.
 *
 * @category Result
 *
 * @version 1.0.0
 ...
 */
final readonly class ResendPasswordResetResult implements ResultMessage
{
  // #region Constants
  ...
  public static function success(
    ...
    string $message = 'A new password reset code has been sent.',
  ): self {
    return new self(
      success: true,
      message: $message,
