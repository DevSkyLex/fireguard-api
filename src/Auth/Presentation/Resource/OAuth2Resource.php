...
use ArrayObject;
use Auth\Presentation\Http\OAuth2\{
  IssueTokenProcessor,
  IntrospectTokenProcessor,
  RevokeTokenProcessor
};
use Auth\Presentation\Http\WellKnown\UserInfoProvider;
use Auth\Presentation\Http\Consent\CheckConsentProvider;
use Auth\Presentation\Dto\Input\{
  TokenInput,
...
#[ApiResource(
  ...
  operations: [
    ...
    new Get(
      ...
      normalizationContext: ['groups' => [AuthSerializationGroup::CONSENT_READ]],
      openapi: new Operation(
        tags: ['OAuth2'],
