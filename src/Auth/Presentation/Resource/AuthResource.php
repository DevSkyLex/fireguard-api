 ...
 * @final
 *
 * User Authentication API Resource.
 *
 * This resource exposes endpoints for user authentication including
 * login, logout, and token refresh operations. Uses HTTP-only cookies
 * for refresh token storage for enhanced security.
 *
 * @category Resource
