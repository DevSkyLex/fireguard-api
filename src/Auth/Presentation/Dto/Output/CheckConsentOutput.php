 ...
 * @final
 *
 * Output data for consent check response.
 * Indicates whether user has granted consent for specific scopes.
 * Returned by the GET /api/oauth2/consent/check endpoint.
 *
 * @category Output DTO
...
final class CheckConsentOutput
{
   ...
   * @var bool
   */
  #[Groups(groups: [AuthSerializationGroup::CONSENT_READ])]
