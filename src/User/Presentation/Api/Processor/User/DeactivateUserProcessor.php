 ...
 */
final readonly class DeactivateUserProcessor implements ProcessorInterface
{
  // #region Constructor
  /**
   * Constructor.
   ...
   * Method process.
   *
   * Processes the deactivate user request.
   *
   * @since 1.0.0
   *
  ...
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): ?UserOutput
  {
    ...
    $this->commandBus->dispatch(
      command: new DeactivateUserCommand(id: $id),
    );
