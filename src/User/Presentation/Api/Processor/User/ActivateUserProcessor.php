 ...
 */
final readonly class ActivateUserProcessor implements ProcessorInterface
{
  // #region Constructor
  /**
   * Constructor.
   ...
   * Method process.
   *
   * Processes the activate user request.
   *
   * @since 1.0.0
   *
  ...
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): ?UserOutput
  {
    ...
    $this->commandBus->dispatch(
      command: new ActivateUserCommand(id: $id),
    );
