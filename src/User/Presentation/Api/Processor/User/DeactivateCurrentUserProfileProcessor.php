...
/**
 * Processor DeactivateCurrentUserProfileProcessor.
 *
 * Self-service account deactivation. Deactivates the authenticated user's
 * own account (idempotent) and, via the DeactivateUser handler, revokes
 * all of their active sessions so they are signed out everywhere.
 ...
 *
 * @implements ProcessorInterface<mixed, CurrentUserProfileOutput|null>
 */
final readonly class DeactivateCurrentUserProfileProcessor implements ProcessorInterface
{
  // #region Constructor
  /**
   * Constructor.
   ...
   * @since 1.0.0
   *
   * @param mixed $data the input data (none expected)
   * @param Operation $operation the operation
   * @param array<string, mixed> $uriVariables the URI variables
   * @param array<string, mixed> $context the context
   *
   * @return CurrentUserProfileOutput the deactivated profile
   */
