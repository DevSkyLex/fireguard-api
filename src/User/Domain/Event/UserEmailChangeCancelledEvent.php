...
/**
 * Event UserEmailChangeCancelledEvent.
 *
 * Raised when an authenticated user has cancelled a pending change of their sign-in
 * email address before the confirmation token sent to the new
 ...
 */
final readonly class UserEmailChangeCancelledEvent implements DomainEvent
{
  /**
   * Constructor.
   *
   ...
   * @param string $newEmail the new email address the cancelled request targeted
