...
/**
 * Event UserEmailChangeConfirmedEvent.
 *
 * Raised when an authenticated user has confirmed a change of their sign-in
 * email address: the confirmation token sent to the new address was
 * used and the account email has been updated.
 *
 * @category Event
 *
 * @version 1.0.0
 ...
 */
final readonly class UserEmailChangeConfirmedEvent implements DomainEvent
{
  /**
   * Constructor.
   *
   ...
   * @param string $newEmail the new (now effective) email address
