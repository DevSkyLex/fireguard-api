...
final readonly class DeleteAttachmentProcessor implements ProcessorInterface
{
  ...
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
  {
    ...
    $attachmentId = $uriVariables['attachmentId'] ?? null;
    ...
    try {
    ...
    } catch (EquipmentNotFoundException|AttachmentNotFoundException $exception) {
      ...
      $notFound = $this->findAttachmentNotFoundException($exception);
      if ($notFound instanceof AttachmentNotFoundException) {
        throw new NotFoundHttpException($notFound->getMessage(), $exception);
      }
