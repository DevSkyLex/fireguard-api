...
/**
 * Processor PutUnderMaintenanceProcessor.
 *
 * @category Processor
 *
 * @version 1.0.0
 ...
 */
final readonly class PutUnderMaintenanceProcessor implements ProcessorInterface
{
  ...
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): EquipmentOutput
  {
    ...
    try {
      /** @var PutUnderMaintenanceResult $result */
      $result = $this->commandBus->dispatch(new PutUnderMaintenanceCommand(
