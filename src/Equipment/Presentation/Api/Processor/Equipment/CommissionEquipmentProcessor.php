...
/**
 * Processor CommissionEquipmentProcessor.
 *
 * @category Processor
 *
 * @version 1.0.0
 ...
 */
final readonly class CommissionEquipmentProcessor implements ProcessorInterface
{
  ...
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): EquipmentOutput
  {
    ...
    try {
      /** @var CommissionEquipmentResult $result */
      $result = $this->commandBus->dispatch(new CommissionEquipmentCommand(
