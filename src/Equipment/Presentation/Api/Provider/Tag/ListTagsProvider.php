...
namespace Equipment\Presentation\Api\Provider\Tag;
 ...
 *
 * @implements ProviderInterface<TagOutput>
 */
final readonly class ListTagsProvider implements ProviderInterface
{
  ...
  // #region Methods
  /**
   * @return TraversablePaginator<TagOutput>
   */
