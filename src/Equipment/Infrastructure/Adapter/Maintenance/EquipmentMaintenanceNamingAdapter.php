...
use Maintenance\Application\Port\Outbound\Naming\MaintenanceEquipmentNamingPort;

/**
 * Adapter EquipmentMaintenanceNamingAdapter.
 *
 * Equipment-side implementation of the Maintenance module's naming contract:
 * resolves equipment identifiers into serial numbers in a single query.
 * Mirrors `Equipment\Infrastructure\Adapter\Inspection\EquipmentNamingAdapter`.
 *
 ...
 */
final readonly class EquipmentMaintenanceNamingAdapter implements MaintenanceEquipmentNamingPort
{
  // #region Constructor
  /**
   * Constructor.
