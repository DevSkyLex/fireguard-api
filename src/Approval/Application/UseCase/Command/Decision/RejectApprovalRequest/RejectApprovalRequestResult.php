...
/**
 * UseCase RejectApprovalRequestResult.
 *
 * @category UseCase
 *
 * @version 1.0.0
 ...
 */
final readonly class RejectApprovalRequestResult implements ResultMessage
{
  // #region Constructor
  /**
   * Constructor.
   ...
   * @param ?DateTimeImmutable $executedAt always null: rejection never executes the deferred action
   * @param ?string $executionError always null: rejection never executes the deferred action
   */
