...
/**
 * UseCase WithdrawApprovalRequestResult.
 *
 * @category UseCase
 *
 * @version 1.0.0
 ...
 */
final readonly class WithdrawApprovalRequestResult implements ResultMessage
{
  // #region Constructor
  /**
   * Constructor.
   ...
   * @param ?DateTimeImmutable $executedAt always null: withdrawal never executes the deferred action
   * @param ?string $executionError always null: withdrawal never executes the deferred action
   */
