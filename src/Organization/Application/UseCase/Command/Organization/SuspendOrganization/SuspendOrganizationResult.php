...
/**
 * UseCase SuspendOrganizationResult.
 *
 * @category UseCase
 *
 * @version 1.0.0
 ...
 */
final readonly class SuspendOrganizationResult implements ResultMessage
{
  // #region Constructor
  /**
   * Constructor.
   *
   * Initializes a new instance of the SuspendOrganizationResult class.
   *
   * @since 1.0.0
   *
