...
/**
 * UseCase CreateOrganizationRoleResult.
 *
 * @category UseCase
 *
 * @version 1.0.0
 ...
 */
final readonly class CreateOrganizationRoleResult implements ResultMessage
{
  // #region Constructor
  /**
   * Constructor.
   *
   * Initializes a new instance of the CreateOrganizationRoleResult class.
   *
   * @since 1.0.0
   *
