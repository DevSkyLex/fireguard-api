...
/**
 * UseCase AddOrganizationMemberResult.
 *
 * @category UseCase
 *
 * @version 1.0.0
 ...
 */
final readonly class AddOrganizationMemberResult implements ResultMessage
{
  // #region Constructor
  /**
   * Constructor.
   *
   * Initializes a new instance of the AddOrganizationMemberResult class.
   *
   * @since 1.0.0
   *
