...
/**
 * UseCase ReactivateOrganizationMemberResult.
 *
 * @category UseCase
 *
 * @version 1.0.0
 ...
 */
final readonly class ReactivateOrganizationMemberResult implements ResultMessage
{
  // #region Constructor
  /**
   * Constructor.
   *
   * Initializes a new instance of the ReactivateOrganizationMemberResult class.
   *
   * @since 1.0.0
   *
   ...
   * @param list<string> $roleIds the member's current role identifiers
