...
/**
 * Provider GetOrganizationFacilityStatisticsProvider.
 *
 * @category Provider
 *
 * @version 1.0.0
 ...
 *
 * @implements ProviderInterface<OrganizationFacilityStatisticsOutput>
 */
final readonly class GetOrganizationFacilityStatisticsProvider implements ProviderInterface
{
   ...
   * GetOrganizationFacilityStatisticsProvider class.
   *
   * @since 1.0.0
   *
   ...
   * Method provide.
   *
   * Provides facility statistics for the requested organization.
   *
   * @since 1.0.0
   *
   ...
   */
  public function provide(Operation $operation, array $uriVariables = [], array $context = []): ?OrganizationFacilityStatisticsOutput
  {
    ...
    try {
      /** @var GetOrganizationFacilityStatisticsResult $result */
      $result = $this->queryBus->ask(new GetOrganizationFacilityStatisticsQuery($organizationId, $user->getId()));
    ...
    $output = new OrganizationFacilityStatisticsOutput();
    $output->totalCount = $result->totalCount;
    $output->activeCount = $result->activeCount;
    $output->archivedCount = $result->archivedCount;
