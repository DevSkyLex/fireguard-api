 ...
 */
final class ClientRepository implements ClientRepositoryPort, OAuthClientRepositoryPort
{
  // #region Properties
  /**
   * Property repository.
   ...
   * @since 1.0.0
   *
   * @param \OAuth\Domain\ValueObject\Client\OAuthClientIdentifier $identifier the client identifier
   *
   * @return \OAuth\Domain\Model\Client\OAuthClient|null the client or null if not found
   */
  public function find(\OAuth\Domain\ValueObject\Client\OAuthClientIdentifier $identifier): ?\OAuth\Domain\Model\Client\OAuthClient
  {
    ...
    return ClientMapper::toOAuthClient(record: $record);
  }
  // #endregion
}
