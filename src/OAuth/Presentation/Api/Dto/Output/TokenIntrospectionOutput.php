 ...
 * @final
 *
 * Output data for OAuth2 token introspection response (RFC 7662).
 * Contains metadata about the inspected token.
 * Returned by the POST /api/oauth2/token/introspect endpoint.
 *
 * @category Output DTO
