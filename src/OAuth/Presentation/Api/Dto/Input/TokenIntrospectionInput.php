 ...
 * @final
 *
 * Input data for OAuth2 token introspection (RFC 7662).
 * Allows resource servers to validate and inspect tokens.
 * Used by the POST /api/oauth2/token/introspect endpoint.
 *
 * @category Input DTO
