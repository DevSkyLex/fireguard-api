 ...
 * @final
 *
 * Input data for OAuth2 token issuance (RFC 6749).
 * Supports multiple grant types: client_credentials, refresh_token, authorization_code.
 * Used by the POST /api/oauth2/token endpoint.
 *
 * @category Input DTO
