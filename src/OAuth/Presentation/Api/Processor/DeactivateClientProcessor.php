...
use OAuth\Application\UseCase\Command\DeactivateClient\DeactivateClientCommand;
 ...
 * @final
 *
 * API Platform processor for deactivating a client.
 *
 * @category Processor
...
final readonly class DeactivateClientProcessor implements ProcessorInterface
{
   ...
   * Constructor
   *
   * Initializes a new instance of the DeactivateClientProcessor class.
   *
   * @access public
   * @since 1.0.0
   *
