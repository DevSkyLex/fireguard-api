...
use Equipment\Application\Port\Outbound\InterventionScopePort;
use Intervention\Application\Port\Outbound\InterventionResourceGatewayPort;

/**
 * Adapter InterventionScopeAdapter.
 *
 * Implements the Equipment module's intervention scope port using this
 * module's own resource gateway. Twin of
 * {@see \Intervention\Infrastructure\Adapter\Inspection\InterventionScopeAdapter} —
 * each consumer declares its own port, so each gets its own adapter.
 *
