...
/**
 * Record InterventionWorkItemRecord.
 *
 * @category Record
 *
 * @version 1.0.0
 ...
 */
#[ORM\Entity]
#[ORM\Table(name: 'intervention_work_items')]
#[ORM\Index(name: 'idx_intervention_work_item_intervention_status', columns: ['intervention_id', 'status'])]
#[ORM\Index(name: 'idx_intervention_work_item_assignee', columns: ['assignee_id'])]
class InterventionWorkItemRecord
{
   ...
   * @since 1.0.0
   */
  #[ORM\ManyToOne(targetEntity: InterventionRecord::class, inversedBy: 'workItems')]
