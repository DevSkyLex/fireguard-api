...
/**
 * UseCase GetInterventionAttachmentContentResult.
 *
 ...
 * `StreamedResponse`; it performs no decision of its own beyond that
 * translation.
 *
 * @category Result
 *
 ...
 */
final readonly class GetInterventionAttachmentContentResult implements ResultMessage
{
  // #region Constructor
  /**
   * Constructor.
