...
/**
 * Provider ListConversationsProvider.
 *
 * @category Provider
 *
 * @version 1.0.0
 ...
 */
final readonly class ListConversationsProvider implements ProviderInterface
{
  ...
  public function provide(Operation $operation, array $uriVariables = [], array $context = []): object
  {
    ...
    try {
      ...
      $result = $this->queryBus->ask(new ListConversationsQuery(
        userId: $user->getId(),
