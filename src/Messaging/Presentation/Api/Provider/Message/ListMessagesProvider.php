 ...
 */
final readonly class ListMessagesProvider implements ProviderInterface
{
  ...
  public function provide(Operation $operation, array $uriVariables = [], array $context = []): object
  {
    ...
    try {
      /** @var ListMessagesResult $result */
      $result = $this->queryBus->ask(new ListMessagesQuery(
        userId: $user->getId(),
