 ...
 */
final readonly class PinMessageProcessor implements ProcessorInterface
{
  ...
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): MessageOutput
  {
    ...
    try {
      /** @var PinMessageResult $result */
      $result = $this->commandBus->dispatch(new PinMessageCommand(
        userId: $user->getId(),
        messageId: $id,
      ));
