    ...
    new GetCollection(
      ...
      parameters: [
        ...
        'subjectType' => new \ApiPlatform\Metadata\QueryParameter(
          schema: ['type' => 'string'],
          description: 'Subject type filter (facility|equipment|intervention|non_conformity).',
          required: false,
          castToArray: false,
          castToNativeType: false,
          constraints: [],
          openApi: new Parameter(name: 'subjectType', in: 'query', description: 'Subject type filter (facility|equipment|intervention|non_conformity).', required: false, schema: ['type' => 'string']),
        ),
        'subjectId' => new \ApiPlatform\Metadata\QueryParameter(
          schema: ['type' => 'string'],
          description: 'Subject identifier filter.',
          required: false,
          castToArray: false,
          castToNativeType: false,
          constraints: [],
          openApi: new Parameter(name: 'subjectId', in: 'query', description: 'Subject identifier filter.', required: false, schema: ['type' => 'string']),
        ),
        'isArchived' => new \ApiPlatform\Metadata\QueryParameter(
          schema: ['type' => 'boolean'],
          description: 'Archived-flag filter.',
          required: false,
          castToArray: false,
          castToNativeType: false,
          constraints: [],
          openApi: new Parameter(name: 'isArchived', in: 'query', description: 'Archived-flag filter.', required: false, schema: ['type' => 'boolean']),
        ),
        'unreadOnly' => new \ApiPlatform\Metadata\QueryParameter(
          schema: ['type' => 'boolean'],
          description: 'Only return conversations with unread activity.',
          required: false,
          castToArray: false,
          castToNativeType: false,
          constraints: [],
          openApi: new Parameter(name: 'unreadOnly', in: 'query', description: 'Only return conversations with unread activity.', required: false, schema: ['type' => 'boolean']),
        ),
      ],
    ...
    new GetCollection(
      ...
      parameters: [
        'buckets' => new \ApiPlatform\Metadata\QueryParameter(
          schema: ['type' => 'integer'],
          description: 'Number of trailing daily buckets to return, ending today (UTC). Defaults to 26, capped at 366.',
          required: false,
          castToArray: false,
          castToNativeType: false,
          constraints: [],
          openApi: new Parameter(name: 'buckets', in: 'query', description: 'Number of trailing daily buckets to return, ending today (UTC). Defaults to 26, capped at 366.', required: false, schema: ['type' => 'integer']),
        ),
      ],
      openapi: new Operation(parameters: []),
    ),
