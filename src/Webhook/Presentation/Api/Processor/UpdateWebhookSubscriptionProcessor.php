...
/**
 * Processor UpdateWebhookSubscriptionProcessor.
 *
 * @category Processor
 *
 * @version 1.0.0
 ...
 *
 * @implements ProcessorInterface<UpdateWebhookSubscriptionInput, WebhookSubscriptionOutput>
 */
final readonly class UpdateWebhookSubscriptionProcessor implements ProcessorInterface
{
   ...
   */
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): WebhookSubscriptionOutput
  {
    /** @var UpdateWebhookSubscriptionInput $data */
    ...
    try {
      /** @var UpdateWebhookSubscriptionResult $result */
      $result = $this->commandBus->dispatch(new UpdateWebhookSubscriptionCommand(
