 ...
 *
 * @implements ProviderInterface<MissionOutput>
 */
final readonly class MissionProvider implements ProviderInterface
{
   ...
   * Constructor.
   *
   * Initializes a new instance of the MissionProvider class.
   *
   * @since 1.0.0
   *
   ...
   *
   * @return MissionOutput|TraversablePaginator<MissionOutput>
   */
  public function provide(Operation $operation, array $uriVariables = [], array $context = []): object
  {
    ...
    if (is_string($id) && '' !== $id) {
      try {
        ...
        $result = $this->queryBus->ask(new GetMissionWorkflowQuery($user->getId(), 'mission', $id));
