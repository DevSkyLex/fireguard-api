 ...
 */
final class MissionOutputFactory
{
   ...
   *
   * @return MissionOutput the from view result
   */
  public function fromView(MissionWorkflowView $view): MissionOutput
  {
    $data = $view->data;
