...
#[ORM\Index(name: 'idx_mission_organization_status', columns: ['organization_id', 'status'])]
class MissionRecord
{
  /**
   * Property id.
   ...
   */
  #[ORM\OneToMany(mappedBy: 'mission', targetEntity: PublicationRecord::class, cascade: ['remove'])]
   ...
   * @since 1.0.0
   *
   * @var Collection<int, MissionWorkItemRecord>
   */
  #[ORM\OneToMany(mappedBy: 'mission', targetEntity: MissionWorkItemRecord::class, cascade: ['remove'])]
   ...
   * @since 1.0.0
   *
   * @var Collection<int, MissionChangeRecord>
   */
  #[ORM\OneToMany(mappedBy: 'mission', targetEntity: MissionChangeRecord::class, cascade: ['remove'])]
  public Collection $changes;

  /**
   * Constructor.
   *
   * Initializes a new instance of the MissionRecord class.
   *
   * @since 1.0.0
   */
