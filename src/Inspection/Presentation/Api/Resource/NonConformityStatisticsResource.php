    ...
    new Get(
      ...
      parameters: [
        'from' => new \ApiPlatform\Metadata\QueryParameter(
          ...
          description: 'Inclusive ISO 8601 datetime lower bound applied to the non-conformity createdAt.',
          required: false,
          castToArray: false,
          castToNativeType: false,
          constraints: [],
          openApi: new Parameter(name: 'from', in: 'query', description: 'Inclusive ISO 8601 datetime lower bound applied to the non-conformity createdAt.', required: false, schema: ['type' => 'string', 'format' => 'date-time', 'example' => '2026-03-01T00:00:00Z']),
        ),
        'to' => new \ApiPlatform\Metadata\QueryParameter(
          schema: ['type' => 'string', 'format' => 'date-time', 'example' => '2026-03-31T23:59:59Z'],
          description: 'Inclusive ISO 8601 datetime upper bound applied to the non-conformity createdAt.',
          required: false,
          castToArray: false,
          castToNativeType: false,
          constraints: [],
          openApi: new Parameter(name: 'to', in: 'query', description: 'Inclusive ISO 8601 datetime upper bound applied to the non-conformity createdAt.', required: false, schema: ['type' => 'string', 'format' => 'date-time', 'example' => '2026-03-31T23:59:59Z']),
        ),
      ],
