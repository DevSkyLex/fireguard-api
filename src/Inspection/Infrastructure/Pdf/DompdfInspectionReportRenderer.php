...
use Inspection\Application\Port\Outbound\InspectionReportPdfRendererPort;
use Twig\Environment;

/**
 * Adapter DompdfInspectionReportRenderer.
 *
 * Renders `templates/inspection/report.html.twig` and converts the
 * resulting HTML to PDF bytes with dompdf — mirrors
