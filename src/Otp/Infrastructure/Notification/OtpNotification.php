...
use Symfony\Component\Notifier\Notification\{Notification, SmsNotificationInterface};
use Symfony\Component\Notifier\Recipient\{RecipientInterface, SmsRecipientInterface};
use Throwable;
