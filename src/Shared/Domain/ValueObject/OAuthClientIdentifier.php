...
final readonly class OAuthClientIdentifier implements Stringable
{
   ...
   * Constructor
   *
   * Initializes a new instance of the OAuthClientIdentifier class.
   *
   * @access public
   * @since 1.0.0
   *
  ...
  public function __construct(public string $value)
  {
    ...
    if (!preg_match(pattern: self::PATTERN, subject: $value)) {
      throw InvalidOAuthClientIdentifierException::invalidPattern(value: $value);
    }
  }
   ...
   * Method equals
   *
   * Compares two OAuthClientIdentifier objects for equality.
   *
   * @access public
   * @since 1.0.0
   *
   ...
   * Method __toString
   *
   * Returns the string representation of the OAuthClientIdentifier object.
   *
   * @access public
   * @since 1.0.0
   *
