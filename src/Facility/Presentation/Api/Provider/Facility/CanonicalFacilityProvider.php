...
final readonly class CanonicalFacilityProvider implements ProviderInterface
{
  ...
  public function provide(Operation $operation, array $uriVariables = [], array $context = []): object
  {
    ...
    [$organization, $missionId, $recordStatus] = $this->filters();
    ...
    if (null !== $missionId) {
      $query->andWhere('f.missionId = :missionId')->setParameter('missionId', $missionId);
    }
  ...
  private function filters(): array
  {
    ...
    return [$organization, $missionId, is_string($recordStatus) && '' !== $recordStatus ? $recordStatus : (null !== $missionId ? 'draft' : 'published')];
  }
