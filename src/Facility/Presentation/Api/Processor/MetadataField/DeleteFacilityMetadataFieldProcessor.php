...
use Facility\Application\UseCase\Command\MetadataField\DeleteMetadataField\DeleteMetadataFieldCommand;
...
/**
 * Processor DeleteFacilityMetadataFieldProcessor.
 *
 * Deletes the field definition only. Existing facility `metadata` values
 * carrying this key are left untouched — see
 ...
 */
final readonly class DeleteFacilityMetadataFieldProcessor implements ProcessorInterface
{
  // #region Constructor
  ...
  public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): null
  {
    ...
    try {
      $this->commandBus->dispatch(new DeleteMetadataFieldCommand(
