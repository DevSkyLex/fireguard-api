...
namespace TrustedDevice\Infrastructure\EventListener;
 ...
 * @final
 *
 * Adds the trusted device cookie to the response if set by a processor.
 *
 * @category EventListener
 * @package TrustedDevice\Infrastructure\EventListener
 * @version 1.0.0
 *
