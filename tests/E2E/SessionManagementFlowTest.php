...
class SessionManagementFlowTest extends OAuth2WebTestCase
{
  ...
  public function testGetSessionById(): void
  {
    ...
    $this->assertContains(
      $response->getStatusCode(),
      [Response::HTTP_OK, Response::HTTP_NOT_FOUND, Response::HTTP_FORBIDDEN, Response::HTTP_UNAUTHORIZED],
  ...
  public function testRevokeAllSessionsWithValidToken(): void
  {
    ...
    $this->assertContains(
      $response->getStatusCode(),
      [Response::HTTP_OK, Response::HTTP_NO_CONTENT, Response::HTTP_FORBIDDEN, Response::HTTP_UNAUTHORIZED],
