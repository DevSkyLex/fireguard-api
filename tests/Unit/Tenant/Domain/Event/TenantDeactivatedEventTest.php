...
/**
 * Test TenantDeactivatedEventTest.
 *
 * @category Event Tests
 *
 * @author Valentin FORTIN <contact@valentin-fortin.pro>
 */
#[CoversClass(TenantDeactivatedEvent::class)]
final class TenantDeactivatedEventTest extends TestCase
{
  // #region Methods
  #[Test]
  public function testPayload(): void
  {
    $event = new TenantDeactivatedEvent(
      eventId: new Uuid('00000000-0000-4000-a000-000000000012'),
      tenantId: 'tenant-1',
      tenantName: 'Acme',
  ...
  {
    $eventId = new Uuid('00000000-0000-4000-a000-000000000013');
