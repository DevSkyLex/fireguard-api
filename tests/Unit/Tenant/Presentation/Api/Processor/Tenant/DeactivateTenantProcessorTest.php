...
use Tenant\Presentation\Api\Processor\Tenant\DeactivateTenantProcessor;

/**
 * Test DeactivateTenantProcessorTest.
 *
 * @category Processor Tests
 *
 * @author Valentin FORTIN <contact@valentin-fortin.pro>
 */
#[CoversClass(className: DeactivateTenantProcessor::class)]
final class DeactivateTenantProcessorTest extends TestCase
{
  ...
  {
    $processor = new DeactivateTenantProcessor(
  ...
  public function testProcessDispatchesAndReturnsOutput(): void
  {
    ...
    $commandBus->expects(self::once())
      ->method('dispatch')
      ->with(self::callback(
        static fn (DeactivateTenantCommand $command): bool => 'tenant-123' === $command->tenantId,
      ));
