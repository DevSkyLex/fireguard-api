...
/**
 * Test CreateCalendarEventResult.
 *
 * @category Test
 *
 * @author Valentin FORTIN <contact@valentin-fortin.pro>
 */
#[CoversClass(CreateCalendarEventResult::class)]
final class CreateCalendarEventResultTest extends TestCase
{
  ...
  public function itMapsFromDomain(): void
  {
    ...
    $result = CreateCalendarEventResult::fromDomain($event);
