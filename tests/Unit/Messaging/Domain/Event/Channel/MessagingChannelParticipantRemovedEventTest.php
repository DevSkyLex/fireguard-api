...
/**
 * Test MessagingChannelParticipantRemovedEvent.
 *
 * @category Test
 *
 * @author Valentin FORTIN <contact@valentin-fortin.pro>
 */
#[CoversClass(MessagingChannelParticipantRemovedEvent::class)]
final class MessagingChannelParticipantRemovedEventTest extends TestCase
{
  #[Test]
  public function itExposesItsPayloadAndStampsOccurredAt(): void
  {
    $event = new MessagingChannelParticipantRemovedEvent('org-1', 'conv-1', 'member-1', 'user-1');
  ...
  {
    $event = new MessagingChannelParticipantRemovedEvent('org-1', 'conv-1', 'member-1');
