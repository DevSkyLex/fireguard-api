...
final class CreateOrganizationHandlerTest extends TestCase
{
  ...
  public function testInvokeCreatesOrganizationOwnerMemberAndSystemRoles(): void
  {
    ...
    self::assertSame(['organization.read', 'organization.members.read', 'organization.roles.read', 'organization.facilities.read', 'organization.equipment.read', 'organization.inspection.read'], $savedRoles[1]['permissions']);
