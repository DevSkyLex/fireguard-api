 ...
 */
#[CoversClass(SetOrganizationMemberRolesProcessor::class)]
final class SetOrganizationMemberRolesProcessorTest extends TestCase
{
  private const string ORG_ID = '550e8400-e29b-41d4-a716-446655442700';

  private const string MEMBER_ID = '550e8400-e29b-41d4-a716-446655442701';

  private const string USER_ID = '550e8400-e29b-41d4-a716-446655442702';

  private const string ROLE_ID = '550e8400-e29b-41d4-a716-446655442703';
  ...
  public function testProcessThrowsWhenUnauthenticated(): void
  {
    ...
    $processor = new SetOrganizationMemberRolesProcessor(
  ...
  public function testProcessThrowsWhenUriVariablesMissing(): void
  {
    ...
    $processor->process($this->createInput(), new Put(), ['organizationId' => self::ORG_ID]);
  }
  ...
  public function testProcessThrowsWhenPermissionIsMissing(): void
  {
    ...
    $authorization->expects(self::once())
      ...
      ->with(self::USER_ID, self::ORG_ID, 'organization.roles.manage')
      ->willReturn(false);
  ...
  public function testProcessDispatchesCommandAndMapsOutput(): void
  {
    ...
    $commandBus->expects(self::once())
      ->method('dispatch')
      ->with(self::callback(static function (SetOrganizationMemberRolesCommand $command): bool {
      ...
      ->willReturn(new SetOrganizationMemberRolesResult(
    ...
    $output = $processor->process($this->createInput(), new Put(), ['organizationId' => self::ORG_ID, 'memberId' => self::MEMBER_ID]);
  ...
  {
    $input = new SetOrganizationMemberRolesInput();
    $input->roleIds = [self::ROLE_ID];
