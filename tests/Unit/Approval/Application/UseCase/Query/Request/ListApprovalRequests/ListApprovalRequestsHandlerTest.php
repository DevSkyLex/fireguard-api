...
final class ListApprovalRequestsHandlerTest extends TestCase
{
  ...
  public function testInvokeReturnsPagedResult(): void
  {
    ...
    $result = $this->handler($requests)(new ListApprovalRequestsQuery(self::ORG_ID, 'user-1', 'pending', 'nc_waiver', 1, 30));
  ...
  private function handler(ApprovalRequestRepositoryPort $requests): ListApprovalRequestsHandler
  {
