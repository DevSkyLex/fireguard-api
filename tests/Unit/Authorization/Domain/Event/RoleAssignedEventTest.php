...
use Authorization\Domain\Event\RoleAssignedEvent;
...
/**
 * Test RoleAssignedEventTest.
 *
 * @category Event Tests
 *
 * @author Valentin FORTIN <contact@valentin-fortin.pro>
 */
#[CoversClass(RoleAssignedEvent::class)]
final class RoleAssignedEventTest extends TestCase
{
  // #region Methods
  #[Test]
  public function testPayloadAndMetadata(): void
  {
    ...
    self::assertSame('user', $payload['subjectType']);
  }
  // #endregion
}
