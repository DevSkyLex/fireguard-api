...
#[CoversClass(ListNonConformitiesProvider::class)]
final class ListNonConformitiesProviderTest extends TestCase
{
  ...
  #[Test]
  public function testProvideReturnsPaginatedNonConformities(): void
  {
    $security = $this->createStub(Security::class);
    $security->method('getUser')->willReturn($this->createSecurityUser());
  ...
  private function makeAuthorizedProvider(Throwable $queryException): ListNonConformitiesProvider
  {
    $security = $this->createStub(Security::class);
    $security->method('getUser')->willReturn($this->createSecurityUser());
    ...
    return new ListNonConformitiesProvider(
      queryBus: $queryBus,
      authorization: $authorization,
      security: $security,
      requestStack: $requestStack,
