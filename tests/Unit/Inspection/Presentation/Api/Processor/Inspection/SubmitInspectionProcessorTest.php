...
#[CoversClass(SubmitInspectionProcessor::class)]
final class SubmitInspectionProcessorTest extends TestCase
{
  ...
  public function testProcessDispatchesCommandAndReturnsOutput(): void
  {
    ...
    $commandBus->expects(self::once())
      ->method('dispatch')
      ->with(self::callback(static function (SubmitInspectionCommand $command): bool {
    ...
    $queryBus->expects(self::once())
      ...
      ->willReturn($this->makeGetInspectionResult('submitted'));
    ...
    self::assertSame('submitted', $output->status);
  }
  ...
  #[Test]
  public function testProcessThrowsConflictWhenAlreadySubmitted(): void
  {
    $processor = $this->makeAuthorizedProcessor(
