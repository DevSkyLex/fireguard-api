...
/**
 * Test FacilityArchivedEvent.
 *
 * @category Test
 *
 * @author Valentin FORTIN <contact@valentin-fortin.pro>
 */
#[CoversClass(FacilityArchivedEvent::class)]
final class FacilityArchivedEventTest extends TestCase
{
  #[Test]
  public function testConstructorExposesPayload(): void
  {
    $before = new DateTimeImmutable();
    $event = new FacilityArchivedEvent(
