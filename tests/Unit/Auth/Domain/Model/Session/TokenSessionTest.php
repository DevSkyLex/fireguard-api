...
namespace Tests\Unit\Auth\Domain\Model\Session;

use Auth\Domain\Event\Session\{UserLoggedInEvent, UserLoggedOutEvent};
use Auth\Domain\Event\Token\{TokenIssuedEvent, TokenRevokedEvent};
use Auth\Domain\Model\Session\TokenSession;
 ...
 *
 * @covers \Auth\Domain\Model\Session\TokenSession
 */
