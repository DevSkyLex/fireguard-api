...
namespace Tests\Unit\Auth\Domain\Model\Client;
 ...
 *
 * @covers \Auth\Domain\Model\Client\Client
 */
...
final class ClientTest extends TestCase
{
  ...
  {
    $identifier = new ClientIdentifier(value: 'client_id');
    $name = 'Test Client';
  ...
  {
    $client = new Client(
      identifier: new ClientIdentifier('client_id'),
      name: 'Test Client',
      redirectUris: ['https://example.com/callback'],
      grantTypes: [GrantType::AUTHORIZATION_CODE],
      scopes: [Scope::READ],
